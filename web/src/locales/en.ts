...
The above is the content you need to summarize.`,
      ...
      timeWeightTip:
        'Newer documents get higher retrieval priority, range 0.8~1.0',
      importanceLevel: 'Importance Level',
      importanceLevelTip:
        'Set document importance: High→1.0, Medium→0.9, Low→0.8',
      importanceLow: 'Low',
      importanceMedium: 'Medium',
      importanceHigh: 'High',
      customWeight: 'Custom Weight',
      customWeightTip: 'Manually set extra score boost, range 0~2, default 1.0',
      tagName: 'Tag',
      frequency: 'Frequency',
...
Example: Virtual Hosted Style`,
    ...
    fileManager: {
      ...
      preprocessOnCreation: 'Preprocess on creation',
      preprocessScript: 'Preprocess script path',
      preprocessModel: 'Preprocess model',
      scriptParamsPreview: 'Script params',
      apiBaseFromFactory: 'API base will use factory default',
      preprocessApiBase: 'LLM API Base',
      preprocessApiKey: 'LLM API Key',
      preprocessModelName: 'LLM Model Name',
      directory: 'Directory',
      uploadTitle: 'Drag and drop your file here to upload',
      uploadDescription:
        'Supports single or batch file upload. For a locally deployed RAGFlow: the total file size limit per upload is 1GB, with a batch upload limit of 32 files. There is no cap on the total number of files per account. For cloud.ragflow.io, the total file size limit per upload is 10MB, with each file not exceeding 10MB and a maximum of 128 files per account.',
