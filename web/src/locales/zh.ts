...
以上就是你需要总结的内容。`,
      ...
      pageRank: '页面排名',
      timeWeight: '时间权重',
      timeWeightTip: '文档入库越新，检索优先级越高，范围 0.8~1.0',
      importanceLevel: '重要性等级',
      importanceLevelTip: '设置文档重要程度，高→1.0，中→0.9，低→0.8',
      importanceLow: '低',
      importanceMedium: '中',
      importanceHigh: '高',
      customWeight: '自定义权重',
      customWeightTip: '手动设置额外加分权重，范围 0~2，默认 1.0',
...
示例：general/v2/`,
    ...
    fileManager: {
      ...
      preprocessModel: '预处理模型',
      scriptParamsPreview: '脚本参数预览',
      apiBaseFromFactory: 'API 地址将使用厂商默认值',
